...
[![tests](https://github.com/nova-kit/nova-queued-export-as-csv/actions/workflows/tests.yaml/badge.svg)](https://github.com/nova-kit/nova-queued-export-as-csv/actions/workflows/tests.yaml)
